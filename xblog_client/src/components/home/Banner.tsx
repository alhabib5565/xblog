const Banner = () => {
  return (
    <div className="flex flex-col md:flex-row gap-8 md:h-[24em]">
      <div className="relative w-full h-full md:w-2/3 rounded-t">
        <img
          className="w-full h-[24em] md:h-full rounded-t"
      ...
      <div className="relative w-full h-full md:w-1/3 rounded-t">
        <img
          className="w-full h-[24em] md:h-full rounded-t"
